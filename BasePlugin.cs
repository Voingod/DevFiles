...
{ 
    public abstract class BasePlugin : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            localcontext.Trace(string.Format(CultureInfo.InvariantCulture, "Entered {0}.Execute()", this.GetType().ToString()));
            ...
            {
                localcontext.Trace(string.Format(CultureInfo.InvariantCulture, "Exiting {0}.Execute()", this.GetType().ToString()));
            }
        }
    }
